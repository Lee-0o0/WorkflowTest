...
public final class DefinitionModels {
    ...
    public enum ProjectHookType { BEFORE_EACH_GROUP }
    public enum StepType { HTTP, SQL, DELAY, SET_VAR, DELETE_VAR }
    ...
    public record ProjectHook(Long id, Long projectId, ProjectHookType hookType,
                              boolean enabled, List<Step> steps) {}
